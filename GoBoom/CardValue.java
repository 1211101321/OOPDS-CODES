public enum CardValue {
    ...
    private char cardSuit; //data field
    private int cardValue;

    private CardValue(char suit, int value) { //constructor
        this.cardValue = value;
        this.cardSuit = suit;
    }

    public int getCardValue() { //get card value (actually dunno why its 2 methods)
        return cardValue;
    }

    public char getCardSuit() { // this also 
        return cardSuit;
    }

    @Override
    public String toString() { //modify to set the value to set in the deck
        String cardString;
        switch (cardValue) {
            case 11:
                cardString = "J";
